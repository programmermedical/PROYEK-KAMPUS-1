  ...
  <body  style="background: url(../PROYEK-KAMPUS-1/assets/img/hero-bg.png)";>
      ...
      <div class="container d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
          <ul>
            <li><a class="nav-link scrollto" href="bau-index.php">Home</a></li>
            <li><a class="nav-link scrollto" href="bau-index.php#edit">Edit data</a></li>
            <li><a class="nav-link scrollto" href="bau-insert.php#insert">Insert data</a></li>
            <li class="dropdown">
      ...
      <table class="table1" data-aos="zoom-in" data-aos-delay="200" style="width: 80%;">
          ...
          <tbody>
            <tr>
              ...
              <button class="btn-option">Hapus</button></td>
            </tr>
            <tr>
              <td>1</td>
              <td>Mark</td>
    ...
    <footer id="footer" style="box-shadow: 0 0 17px 4px hsla(0, 0%, 0%, 0.507);">
      ...
      <div class="container footer-bottom clearfix">
        <div class="copyright">
          &copy; Copyright <strong><span>ITSK RS Dr. Soepraoen</span></strong
