...
//   echo "<script>swal({title: 'Berhasil!',text: 'Pop-up berhasil ditampilkan', icon: 'success', button: true});</script>";
// } else if (isset($_GET["gagal"])) {
//   echo "<script>alert('Data gagal diinputkan, silahkan cek kembali input data anda!!')</script>";
// }
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="container">
            ...
            <div class="insert-form" data-aos="fade-up">
                <form action="proses-upload.php" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                        <label for="name" class="form-label" data-aos="fade-right">Nama dokumen</label>
                        <input type="text" class="form-control" id="nama" name="nama" data-aos="fade-left" placeholder="Silahkan masukkan nama dokumen" required>
                    </div>
                    <div class="mb-3">
                        <label for="berkas" class="form-label" data-aos="fade-right">Dokumen</label>
                        <input type="file" class="form-control" id="berkas" name="berkas" data-aos="fade-left" placeholder="Silahkan masukkan mata kuliah" required>
                        <div id="emailHelp" class="form-text" data-aos="fade">Format : .doc | .pdf | .xslx</div>
                    </div>
