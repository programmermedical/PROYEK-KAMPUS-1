...
<body>
  <!-- ======= Hero Section ======= -->
  <section id="hero" style="box-shadow: 0 4px 17px hsla(0, 0%, 0%, 0.507);">
    <div class="hero-container">
      <a href="index.html" class="hero-logo" data-aos="zoom-in">
        <img src="assets/img/itsk-logo.png" alt="ITSK-LOGO" width="250" height="250" />
      </a>
