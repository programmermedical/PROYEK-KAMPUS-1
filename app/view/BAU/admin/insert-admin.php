...
<body style="background: url(../PROYEK-KAMPUS-1/../../../../assets/img/hero-bg.png)" ;>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown">
            ...
            <ul>
              <li class="dropdown">
                <a href="#admin"><span>Data Perkuliahan</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
  ...
  <!-- ======= Insert ======= -->
  <section id="insert_admin">
    <div class="container">
      <div class="section-title" data-aos="fade-up">
        <h2 style="color: #fff;">Tambahkan admin</h2>
      </div>
      <div class="insert-form" data-aos="fade-up">
        <form>
          <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label" data-aos="fade-right">Nama</label>
            <input type="text" class="form-control" id="exampleInputtext1" data-aos="fade-left" placeholder="Silahkan masukkan nama admin" required>
          </div>
          <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label" data-aos="fade-right">Username</label>
            <input type="text" class="form-control" id="exampleInputtext1" data-aos="fade-left" placeholder="Silahkan masukkan username admin" required>
            <div id="emailHelp" class="form-text" data-aos="fade">Contoh : s1informatika_21</div>
          </div>
          <div class="mb-3">
            <label for="exampleInputtext1" class="form-label" data-aos="fade-right">Password</label>
            <input type="text" class="form-control" id="exampleInputtext1" data-aos="fade-left" placeholder="Silahkan masukkan kelas password admin" required>
          </div>
          <div class="mb-3">
            <label for="exampleInputtext1" class="form-label" data-aos="fade-right">Level</label>
            ...
            <div id="emailHelp" class="form-text" data-aos="fade">Admin = Admin BAU | Pegawai = Admin Prodi</div>
          </div>
